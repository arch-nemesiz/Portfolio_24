...
const Footer = () => {
  return (
    <div id="footer" className="relative z-[30] pt-[8rem] pb-[4rem] bg-[#02050a]">
      <h1 className="heading">CONTACT<span className="text-yellow-400">INFO</span></h1>
      <section className="grid md:grid-cols-2 py-10 md:py-10 gap-2 w-[80%] mx-auto items-center"></section>
      ...
      <div className="w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between">
        <div className="text-[16px] mb-[2rem] md:mb-0 text-white opacity-20">
          Rahul's portfolio as on 2024 | All Rights Reserved
        </div>
